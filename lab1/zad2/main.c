...
void writeResults(FILE* output, char* opName, clock_t startTime, clock_t endTime, struct tms startTmsTime, struct tms endTmsTime){
...
int main(int argc, char** argv){
    ...
    for(int i=1; i < argc; i++){     // i=1, bo pomijamy nazwe programu
        ...
        writeResults(output, currentOperation, startTime, endTime, startTmsTime, endTmsTime);
